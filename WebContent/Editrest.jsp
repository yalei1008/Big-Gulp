...
<div class="container">
	...
	<h3>Edit Restaurant</h3>		
		<form role="form" method="post" action="editrest">
			...
			<div class="form-group">
				<input type="text" class="form-control" name="address" placeholder="Edit Address" value="${address}">
			</div>
			
			<div class="form-group">
				<input type="text" class="form-control" name="description" placeholder="Edit Description" value="${description}">
			</div>
