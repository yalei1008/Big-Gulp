...
public class Restaurants extends HttpServlet {
	...
	private String listRestaurants() {
		String ans = "<thead><tr><th>Name</th><th>Address</th><th>Description</th><th>Number of reviews</th><th>Average Rating</th><th></th></thead>";
		ans += "<tbody>";
		...
		try {
			...
			while (rs.next()) {
				...
				ans += "<td><a href=\"editrest?restID=" + rs.getString("id") + "\">Edit</td>";
				ans += "</tr>";
			}
